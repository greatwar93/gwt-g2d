...
//	}
	...
	public void drawImage(ImageElement image, double x, double y) {
		...
		impl.drawImage(image, 0, 0, width, height, x, y, width, height);
	}
	 ...
	 * @param height
	 */
	public void drawImage(ImageElement image, double x, double y, double width, double height) {
		impl.drawImage(image, 0, 0, image.getWidth(), image.getHeight(), x, y, width, height);
	}
	...
	/**
	 * The style the canvas applies when stroking paths. When you set this
	 * property, the canvas sets the stroke style parameter of the graphics
	 * state.
	 * <p>
	 * You can set the stroke style to be a linear or radial gradient. Use the
	 ...
	 * 
	 * @param strokeStyle a Gradient representing the stroke style
	 */
	public void setStrokeStyle(Gradient strokeStyle) {
		if (strokeStyle == null) {
			throw new IllegalArgumentException();
		}
		strokeGradient = strokeStyle;
		impl.setStrokeStyle(strokeStyle);
	}
	 ...
	 * description.
	 * 
	 * @return a color String or Gradient object representing the stroke style
	 */
	...
	/**
	 * See setter method {@link #setFont(String)}.
	 */
